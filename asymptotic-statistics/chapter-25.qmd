...
<span id="equation-25-3-von-mises"></span>
...
- **Point-mass contamination.** Pretend the data are discrete and differentiate
    ...
    <span id="equation-25-3-contamination"></span>
...
\boxed{
\begin{gathered}
\text{derive a candidate}\;\longrightarrow\;\text{verify every score identity}\\
\longrightarrow\;\text{project if necessary}
\end{gathered}
}
$$
...
\begin{aligned}
\int\biggl[
&p_{\theta+h}^{1/2}-p_\theta^{1/2}\\
&\quad-\frac12h^T\dot\ell_\theta p_\theta^{1/2}
\biggr]^2d\mu
&=o(|h|^2).
\end{aligned}
$$
...
$$
\begin{aligned}
\frac{\left(\left.\frac{d}{dt}\right|_{t=0}\psi(P_t)\right)^2}{Pg^2}
...
\frac{\langle\widetilde\psi_P,g\rangle_P^2}{\langle g,g\rangle_P}
&=P\widetilde\psi_P^2.
\end{aligned}
$$
...
$$
\begin{aligned}
&\sup_I\liminf_{n\to\infty}\sup_{g\in I}
E_{P_{1/\sqrt n,g}^n}
\ell\left(\sqrt n\left[T_n-\psi(P_{1/\sqrt n,g})\right]\right)\\
&\qquad\geq
\int\ell\,dN\left(0,P\widetilde\psi_P\widetilde\psi_P^T\right),
\end{aligned}
$$
...
$$
\begin{aligned}
\sqrt n\left[T_n-\psi(P)\right]
&=\frac{1}{\sqrt n}\sum_{i=1}^n\widetilde\psi_P(X_i)
+o_P(1).
\end{aligned}
\tag{25.22}
$$
...
<span id="equation-25-4-dml-orthogonality"></span>
...
<span id="equation-25-31-underlying-derivative"></span>
...
<span id="equation-25-31-observed-derivative"></span>
...
Equations [(25.31a)](#equation-25-31-underlying-derivative)–[(25.31b)](#equation-25-31-observed-derivative) agree for every direction in a dense linear span if and only if
...
<span id="equation-25-32-characteristic-identity"></span>
...
Differentiate [(25.32a)](#equation-25-32-characteristic-identity) at $s=0$. Gaussian exponential integrability justifies differentiation and gives
...
<span id="equation-25-32-continuity"></span>
...
defines a linear functional on $R(A)$, and [(25.32b)](#equation-25-32-continuity) makes it continuous in the $L_2(P_\eta)$ norm. Extend $D$ to $\overline{R(A)}$. By the Riesz representation theorem, there exists $h\in\overline{R(A)}$ such that
...
&=\left[I-B_{\theta,\eta}
(B_{\theta,\eta}^*B_{\theta,\eta})^{-1}
B_{\theta,\eta}^*\right]\dot\ell_{\theta,\eta}.
\end{aligned}
\tag{25.33}
$$
...
$$
A_{\theta,\eta}^*A_{\theta,\eta}
=
\begin{pmatrix}
I_{\theta,\eta}
&P_{\theta,\eta}\dot\ell_{\theta,\eta}B_{\theta,\eta}\\
B_{\theta,\eta}^*\dot\ell_{\theta,\eta}
...
$$
\begin{aligned}
\widetilde\psi_{P_{\theta,\eta}}
&=B_{\theta,\eta}
(B_{\theta,\eta}^*B_{\theta,\eta})^{-}\widetilde\chi_\eta\\
&\quad-
\left\langle
B_{\theta,\eta}(B_{\theta,\eta}^*B_{\theta,\eta})^{-}
\widetilde\chi_\eta,
\dot\ell_{\theta,\eta}
\right\rangle_{P_{\theta,\eta}}^T
\widetilde I_{\theta,\eta}^{-1}
\widetilde\ell_{\theta,\eta}.
\end{aligned}
$$
...
<span id="equation-25-41-aipw"></span>
...
$$
\begin{aligned}
\limsup_{n\to\infty}\pi_n(P_{h/\sqrt n,g})
&\leq1-\Phi\left(
z_\alpha-h\frac{P\widetilde\psi_Pg}
...
<span id="equation-25-44-finite-bound"></span>
...
<span id="equation-25-45-power"></span>
...
The normal distribution has no mass at $z_\alpha$, so convergence of rejection probabilities gives [(25.45a)](#equation-25-45-power).
...
<span id="equation-25-7-chain-rule"></span>
...
The candidate in [(25.7a)](#equation-25-7-chain-rule) is therefore the efficient influence function, not merely an arbitrary influence function. Consequently, the efficient covariance bound transforms as
...
<span id="equation-25-7-banach-path"></span>
...
<span id="equation-25-47-support"></span>
...
<span id="equation-25-47-scalar-delta"></span>
...
It belongs to the closed tangent space, so it is the efficient influence function of $e^*\phi\circ\psi$. Equation [(25.47b)](#equation-25-47-scalar-delta) proves that every scalar view $e^*\phi(T_n)$ is efficient. Together with the tight transformed limit, this is precisely Banach-valued efficiency.
...
Thus $\mathbb D'=\{\pi_s:s\in S\}$ satisfies the norming condition [(25.49a)](#equation-25-49-norming) with $C=1$. By hypothesis, $\pi_sT_n=T_n(s)$ is efficient for $\pi_s\psi(P)=\psi(P)(s)$ for every $s$, and the displayed weak convergence makes $\sqrt n\{T_n-\psi(P)\}$ asymptotically tight. [Lemma 25.49](#lemma-25-49) therefore implies efficiency of $T_n$ in $\ell^\infty(S)$.
...
<span id="equation-25-49-norming"></span>
...
<span id="equation-25-49-embedding"></span>
...
The influence functions have an $L_2(P)$ limit. Passing to the limit in their derivative identities and using [(25.49c)](#equation-25-49-discrete) shows that this limit represents $d^*\dot\psi_P$; because it lies in the closed tangent space, it is $\widetilde\psi_{P,d^*}$. Hence

<span id="equation-25-49-all-duals"></span>
...
Thus $\mathbb D'$ satisfies [(25.49a)](#equation-25-49-norming) with $C=1$. [Lemma 25.49](#lemma-25-49) applied in the product space proves joint efficiency.
...
<span id="equation-25-8-score"></span>
...
<span id="equation-25-54-expansion"></span>
...
<span id="equation-25-54-equicontinuity"></span>
...
$o_P(n^{-1/2}+\|\delta_n\|)$, [(25.54b)](#equation-25-54-equicontinuity) yields

<span id="equation-25-54-population-side"></span>
...
<span id="equation-25-54-dqm"></span>
...
<span id="equation-25-54-information-identity"></span>
...
and substitute [(25.54d)](#equation-25-54-dqm). After subtracting
$\widetilde I_{\theta,\eta}\delta_n$, the difference is exactly
$R_{1n}+R_{2n}+R_{3n}$, where

<span id="equation-25-54-three-remainders"></span>
...
The first part of (25.53) gives $P\|\widehat f-f\|^2=o_P(1)$ and hence $P\|\widehat f\|^2=O_P(1)$; its last part gives $\widehat P\|\widehat f\|^2=O_P(1)$. Cauchy--Schwarz, [(25.54d)](#equation-25-54-dqm), and these two bounds imply
...
<span id="equation-25-54-linearization"></span>
...
Combining [(25.54c)](#equation-25-54-population-side) and [(25.54g)](#equation-25-54-linearization),

<span id="equation-25-54-preliminary"></span>
...
[(25.54h)](#equation-25-54-preliminary) and multiply by
$\widetilde I_{\theta,\eta}^{-1}$ to obtain [(25.54a)](#equation-25-54-expansion).
...
<span id="equation-25-8-one-step"></span>
...
<span id="equation-25-8-functional-one-step"></span>
...
This uses the notation of [§25.3](#sec-influence-functions); @kennedy2022 writes $\varphi(\,\cdot\,;\widehat P)$ in place of $\psi_{\widehat P}^\dagger$. Choose the centered representative, so $\widehat P\psi_{\widehat P}^\dagger=0$. The reverse expansion [(25.3a)](#equation-25-3-von-mises) then rewrites the plug-in error as $-P\psi_{\widehat P}^\dagger+R_2(\widehat P,P)$. Adding and subtracting the true centered influence function gives the reusable decomposition

<span id="equation-25-8-one-step-decomposition"></span>
...
Fisher and Kennedy's Figure 1B draws [(25.8c)](#equation-25-8-functional-one-step) as a tangent-line correction. The plug-in value $T(\widetilde P)$ is at one endpoint of the path, the tangent line is extrapolated toward the truth, and the remaining vertical gap is $R_2$. Equation [(25.8b)](#equation-25-8-one-step) above starts instead from a finite-dimensional $\widetilde\theta_n$ and takes one Newton step on the efficient-score equation. Because $\widetilde I^{-1}\widetilde\ell$ is the efficient influence function, the two formulas have the same first-order architecture; see §3 and fig. 1 of @fisherKennedy2021 and §§4.1–4.3 of @kennedy2022.
...
If the model is differentiable in quadratic mean in $\theta$, $\widetilde I_{\theta,\eta}$ is nonsingular, and (25.55)--(25.56) hold, then the sample-split one-step estimator [(25.8b)](#equation-25-8-one-step) is asymptotically efficient.
...
<span id="equation-25-57-split-error"></span>
...
$P_{\theta_n,\eta}^{\,n}$ contiguous to $P_{\theta,\eta}^{\,n}$, so [(25.57a)](#equation-25-57-split-error) also holds under the true sample law.

The remaining true-score linearization is the technical implication of DQM and (25.56) used in the source:

<span id="equation-25-57-score-continuity"></span>
...
**Source-deferred technical step.** Van der Vaart's printed proof cites the score-continuity argument in @vanDerVaart1991Differentiable, p. 185, for [(25.57b)](#equation-25-57-score-continuity). Its two ingredients are visible here: (25.56) makes the score-weighted square-root densities $L_2$-continuous, which controls the centered empirical difference under contiguous local laws; DQM gives the population drift, and the projection identity
$P_{\theta,\eta}\widetilde\ell_{\theta,\eta}
\dot\ell_{\theta,\eta}^T=\widetilde I_{\theta,\eta}$
identifies that drift. Thus [(25.57b)](#equation-25-57-score-continuity) is exactly the technical score lemma invoked by the source, not an additional smooth Taylor assumption.

Combining [(25.57a)](#equation-25-57-split-error) and [(25.57b)](#equation-25-57-score-continuity),

<span id="equation-25-57-local-expansion"></span>
...
The preliminary estimator is root-$n$ consistent and lies on a grid of mesh $n^{-1/2}$. On every bounded root-$n$ neighborhood, that grid contains only finitely many possible offsets, with a number bounded independently of $n$. If [(25.57c)](#equation-25-57-local-expansion) failed after replacing $\theta_n$ by $\widetilde\theta_n$, one of those grid values would define a deterministic local sequence along which it failed, contradicting the display. This is precisely the finite-grid argument proved in Theorem 5.48. Hence

<span id="equation-25-57-score-expansion"></span>
...
Finally, substitute [(25.57d)](#equation-25-57-score-expansion) into the one-step definition:
...
<span id="equation-25-8-dml-product-rate"></span>
...
<span id="equation-25-61-score"></span>
...
Because every symmetric distribution integrates an odd function to zero, [(25.61a)](#equation-25-61-score) has **exactly zero bias**. The difficult part of (25.58) reduces to
...
<span id="equation-25-64-var"></span>
...
<span id="equation-25-64-l1"></span>
...
<span id="equation-25-64-discard"></span>
...
For every $s$ with $g(s)>0$, the density event has probability tending to zero. By [(25.64a)](#equation-25-64-var),
...
The Lebesgue measure of the displayed level set tends to zero by [(25.64b)](#equation-25-64-l1) and $\alpha_n\to\infty$. Since $\gamma_n\to0$, dominated convergence applied to [(25.64c)](#equation-25-64-discard) proves that the discarded contribution tends to zero.

On $\widehat B_n$, decompose

<span id="equation-25-64-decomp"></span>
...
Up to a universal multiplicative constant, the square of [(25.64d)](#equation-25-64-decomp) is bounded there by

<span id="equation-25-64-bound"></span>
...
which tends to zero. By [(25.64a)](#equation-25-64-var), the second and third terms contribute at most

<span id="equation-25-64-stochastic"></span>
...
The first expression in [(25.64f)](#equation-25-64-stochastic) vanishes by $n\sigma_n^4\beta_n^2\to\infty$; the second does too once the last integral is shown uniformly bounded.

That bound and convergence of the fourth term follow from one Cauchy–Schwarz inequality:

<span id="equation-25-64-information"></span>
...
<span id="equation-25-64-contraction"></span>
...
<span id="equation-25-64-norm-bound"></span>
...
To verify its hypotheses with $p=2$, let $B=\{g=0\}$. Finite Fisher information makes $g$ continuous, so the enlargements $B^{\sigma_n}$ decrease to $B$; moreover $g'=0$ almost everywhere on $B$. Equation [(25.64h)](#equation-25-64-contraction) therefore shows that the squared $L_2$ mass of $g_n'/g_n^{1/2}$ on $B$ tends to zero. On $B^c=\{g>0\}$, convolution approximation gives
...
in Lebesgue measure. Thus convergence holds in measure on all of $\mathbb R$, while [(25.64i)](#equation-25-64-norm-bound) verifies the required limsup inequality. The stated criterion now gives
...
Every term in [(25.64e)](#equation-25-64-bound) therefore has integrated expectation tending to zero. Together with the discarded-region bound and Markov's inequality, this proves (25.62).
...
<span id="equation-25-8-conditional-score"></span>
...
<span id="equation-25-65-class"></span>
...
<span id="equation-25-65-growth"></span>
...
Partition $\mathbb R$ into $I_j=[j,j+1)$. On $I_j$, [(25.65c)](#equation-25-65-growth) places the restrictions of all $g_{c,\eta}$ in a class with both sup norm and derivative sup norm bounded by
...
<span id="equation-25-65-weighted-bound"></span>
...
If $[l,u]$ brackets the functions $g_{c,\eta}$, then the functions in [(25.65a)](#equation-25-65-class) are bracketed by

<span id="equation-25-65-transfer-bracket"></span>
...
The squared $L_2(P)$ size of [(25.65e)](#equation-25-65-transfer-bracket) equals the squared $L_2(Q)$ size of $[l,u]$ for

<span id="equation-25-65-q"></span>
...
Thus the one-dimensional construction gives [(25.65d)](#equation-25-65-weighted-bound) for fixed $(a,b)$.
...
<span id="equation-25-9-variance"></span>
...
If $\varphi_{\theta,\tau}$ has already been normalized as an influence function, then $J_{\theta,\tau}=I$ and [(25.9c)](#equation-25-9-ee) can be read directly. Multiplying an estimating equation by a fixed nonsingular matrix does not change its root, which is why the book sometimes identifies influence functions only “up to a constant.” The symbol $J$ is a clarification local to these notes; it does not change van der Vaart's estimating functions.
...
<span id="equation-25-66-variance"></span>
...
<span id="equation-25-66-dml"></span>
...
- $\varphi_{\theta,\tau}(W)$ be a candidate full-data influence function, already given the derivative normalization from [(25.9d)](#equation-25-9-z).
...
<span id="equation-25-67-if"></span>
...
<span id="equation-25-67-augmented"></span>
...
For arbitrary working functions $\bar\pi$ and $\bar c$, the mean of [(25.67b)](#equation-25-67-augmented) at the truth is

<span id="equation-25-67-double-robust"></span>
...
<span id="equation-25-67-aipw-building-blocks"></span>
...
<span id="equation-25-67-treatment-mean-if"></span>
...
<span id="equation-25-67-ate-dml"></span>
...
DML estimates $(\mu_0,\mu_1,e)$ on training folds and evaluates this score on held-out folds. In the [one-step decomposition](#sec-25-8-one-step), cross-fitting supplies the conditional independence used to control the estimated-function empirical-process term, together with $L_2$ convergence and moment bounds; the product identity [(25.67c)](#equation-25-67-double-robust) supplies target-specific remainder control, as discussed in §§4.2–4.3 of @kennedy2022 and @chernozhukovEtAl2018. Causal interpretation additionally requires identification assumptions—most importantly consistency, conditional exchangeability, and overlap—which are not supplied by the missing-data geometry alone.
...
5. compare the resulting variance with the efficient bound using [(25.9b)](#equation-25-9-variance).
...
<span id="equation-25-10-empirical-likelihood"></span>
...
<span id="equation-25-10-profile"></span>
...
<span id="equation-25-69-full"></span>
...
<span id="equation-25-69-baseline"></span>
...
<span id="equation-25-69-partial"></span>
...
After maximizing [(25.69c)](#equation-25-69-partial), the baseline cumulative hazard estimate has jumps
...
<span id="equation-25-71-model"></span>
...
<span id="equation-25-71-roughness"></span>
...
<span id="equation-25-71-penalized"></span>
...
<span id="equation-25-71-tuning"></span>
...
<span id="equation-25-72-model"></span>
...
<span id="equation-25-72-likelihood"></span>
...
<span id="equation-25-73-random-censoring"></span>
...
<span id="equation-25-10-random-censoring-likelihood"></span>
...
<span id="equation-25-10-km"></span>
...
<span id="equation-25-74-hazards"></span>
...
<span id="equation-25-74-product-integral"></span>
...
<span id="equation-25-74-hazard-survival"></span>
...
with the common initial value $A(0-)=B(0-)=0$; the product integral is its unique solution. Applying this equivalence to [(25.74b)](#equation-25-74-product-integral) gives

$$
d\Lambda_i=\frac{dF_i}{1-F_{i-}}.
$$

The definitions in [(25.74a)](#equation-25-74-hazards) imply, at every jump time,

<span id="equation-25-74-jumps"></span>
...
<span id="equation-25-74-continuous"></span>
...
The left side of [(25.74d)](#equation-25-74-jumps) is the jump of the cumulative hazard associated with the product of the two survivals, since
...
Equations [(25.74d)](#equation-25-74-jumps)–[(25.74e)](#equation-25-74-continuous) and the hazard/product-integral equivalence therefore give

<span id="equation-25-74-survival"></span>
...
For the first subdistribution, the tie convention requires the post-jump survival $1-F_1$. From the definition of $\Lambda_1$ and [(25.74f)](#equation-25-74-survival),
...
<span id="equation-25-11-exact-path"></span>
...
<span id="equation-25-11-kappa"></span>
...
<span id="equation-25-11-truth-match"></span>
...
<span id="equation-25-11-stationarity"></span>
...
<span id="equation-25-77-expansion"></span>
...
<span id="equation-25-77-score-equation"></span>
...
<span id="equation-25-77-equicontinuity"></span>
...
[(25.77b)](#equation-25-77-score-equation), [(25.77c)](#equation-25-77-equicontinuity), and the no-bias condition (25.75), exactly as in the population-side step of [Theorem 25.54](#theorem-25-54), gives

<span id="equation-25-77-population-side"></span>
...
<span id="equation-25-77-information-identity"></span>
...
<span id="equation-25-77-dqm-linearization"></span>
...
$\kappa_0=\widetilde\ell_{\theta_0,\eta_0}$, multiplication by the inverse information matrix gives [(25.77a)](#equation-25-77-expansion). The influence function is therefore
$\widetilde I_{\theta_0,\eta_0}^{-1}
...
<span id="equation-25-11-current-status-likelihood"></span>
...
<span id="equation-25-11-current-status-efficient-score"></span>
...
<span id="equation-25-11-current-status-path"></span>
...
<span id="equation-25-11-current-status-kappa"></span>
...
At $(\theta_0,\Lambda_0)$, $\phi(\Lambda_0)=1$ and $r_0(\Lambda_0(c))=h_{\theta_0,\Lambda_0}(c)$, so [(25.11i)](#equation-25-11-current-status-kappa) becomes the efficient score.
...
<span id="equation-25-83-midpoint"></span>
...
The conditional densities $p_{\theta,\Lambda}$ are bounded above by one, while the assumptions make $p_0$ bounded away from zero. Hence the functions in [(25.83a)](#equation-25-83-midpoint) are uniformly bounded. Concavity of the logarithm and the definition of the MLE give

<span id="equation-25-83-improvement"></span>
...
<span id="equation-25-83-drift"></span>
...
<span id="equation-25-83-modulus"></span>
...
have order $n^{-1/6}$. Equations [(25.83b)](#equation-25-83-improvement)–[(25.83d)](#equation-25-83-modulus) and [Theorem 25.81](#theorem-25-81) therefore give the stronger joint rate
...
<span id="equation-25-84-transfer"></span>
...
The monotone functions $0\leq\Lambda\leq M$ admit $\exp(C/\varepsilon)$ brackets of Lebesgue-$L_2$ size $\varepsilon$ by [Example 19.11](chapter-19.qmd#example-19.11-bounded-variation). Equation [(25.84a)](#equation-25-84-transfer) transfers those brackets to the midpoint log likelihood.
...
<span id="equation-25-85-equivalence"></span>
...
<span id="equation-25-85-score-form"></span>
...
<span id="equation-25-85-correlation"></span>
...
Since $\widetilde I_0$ is positive definite, the last quadratic form is at most $cP_0g_2^2$ for some $c<1$. [Lemma 25.86](#lemma-25-86) applied to [(25.85b)](#equation-25-85-score-form) now gives

<span id="equation-25-85-separated"></span>
...
The conditional weight $E_0(Q_0^2\mid C=c)$ and the density of $C$ are bounded above and away from zero on $[\sigma,\tau]$. Hence the first term in [(25.85d)](#equation-25-85-separated) is comparable to $\int_\sigma^\tau(\Lambda-\Lambda_0)^2dc$. Nonsingularity of $I_0$ makes the second comparable to $\|\theta-\theta_0\|^2$. Combining this with [(25.85a)](#equation-25-85-equivalence) proves (25.85).
...
<span id="equation-25-86-algebra"></span>
...
Thus [(25.86a)](#equation-25-86-algebra) is at least
...
Closure properties of [Donsker classes](chapter-19.qmd#donsker-classes) control [(25.11i)](#equation-25-11-current-status-kappa), and [Theorem 25.77](#theorem-25-77) now yields efficiency of $\widehat\theta$.
...
<span id="equation-25-11-frailty-model"></span>
...
<span id="equation-25-11-frailty-efficient-score"></span>
...
<span id="equation-25-11-frailty-path"></span>
...
A change of variables in the mixture integral shows that the likelihood derivative along $(\theta+t,\eta_t)$ is exactly [(25.11k)](#equation-25-11-frailty-efficient-score). Therefore the MLE satisfies the efficient score equation itself, and [Theorem 25.54](#theorem-25-54) applies.

The model also has exact no bias:

<span id="equation-25-11-frailty-no-bias"></span>
...
<span id="equation-25-87-class"></span>
...
<span id="equation-25-87-ratio"></span>
...
For $k=2,l=1$, write $h_\eta=R_{2,1,\eta}$. Every function in [(25.87a)](#equation-25-87-class) is a bounded linear combination of terms of the form
...
Equation [(25.87b)](#equation-25-87-ratio) bounds these by a constant times

<span id="equation-25-87-envelope"></span>
...
Under $P_{\theta_0,\eta_0}$, the moment assumptions on $\eta_0$ make the square of [(25.87c)](#equation-25-87-envelope) integrable: the $z^2$ moment controls the large-observation tail, while the $z^{-5}$ moment controls the small-$z$ mixing mass that produces large values of $X$ and $Y$.

It remains to prove the Donsker property. Consider the functions $s\mapsto sh_\eta(s)$. For any fixed $1/2<\alpha<1$, [(25.87b)](#equation-25-87-ratio) and the derivative identity for adjacent Laplace-transform ratios give

<span id="equation-25-87-small"></span>
...
<span id="equation-25-87-large"></span>
...
Partition $(0,1/2]$ into dyadic intervals $[2^{-j},2^{-j+1})$ and $[1/2,\infty)$ into $[1/2,1)$ and $[j,j+1)$. The Hölder bracketing bounds applied to [(25.87d)](#equation-25-87-small)–[(25.87e)](#equation-25-87-large), with the bracket widths allocated according to the probability of each interval, yield

<span id="equation-25-87-entropy"></span>
...
Choose $\alpha>1/2$ and then $W<2$ with $W\geq1/\alpha$. The square root of [(25.87f)](#equation-25-87-entropy) is integrable at zero. Finally, varying $(a_1,a_2,a_3,b_1,b_2)$ over bounded finite-dimensional sets adds only polynomial covering factors, whose logarithms do not affect the entropy integral. The bracketing Donsker theorem therefore proves the assertion, and [(25.87c)](#equation-25-87-envelope) supplies the square-integrable envelope.
...
<span id="equation-25-11-partially-linear-model"></span>
...
<span id="equation-25-11-penalized-least-squares"></span>
...
<span id="equation-25-11-smoothing-rate"></span>
...
<span id="equation-25-88-criterion"></span>
...
<span id="equation-25-88-identification"></span>
...
Because $P_0e=0$ and $e$ is independent of $(V,W)$, [(25.88a)](#equation-25-88-criterion) and [(25.88b)](#equation-25-88-identification) imply

<span id="equation-25-88-drift"></span>
...
<span id="equation-25-88-distance"></span>
...
<span id="equation-25-88-bernstein"></span>
...
<span id="equation-25-88-modulus"></span>
...
<span id="equation-25-88-entropy-integral"></span>
...
The finite-dimensional term $(\theta-\theta_0)V$ does not change this order, so [(25.88f)](#equation-25-88-modulus) remains valid with $\eta-\eta_0$ replaced by $g-g_0$. The same bound applies to $\mathbb G_n(g-g_0)^2$, using
...
Theorem 25.81 applied to [(25.88c)](#equation-25-88-drift)–[(25.88f)](#equation-25-88-modulus) now gives

<span id="equation-25-88-local-rate"></span>
...
<span id="equation-25-88-sobolev"></span>
...
<span id="equation-25-88-linear-part"></span>
...
The empirical mean of the square of the left side of [(25.88j)](#equation-25-88-linear-part) is $a^TA_na$. The assumptions on $(V,W)$ make the population second-moment matrix positive definite, so its smallest eigenvalue, and hence that of $A_n$, is bounded away from zero with probability tending to one. It therefore suffices to bound $\mathbb P_ng^2$ and $J(\eta)$ at the estimator.

Condition on the entire design sequence $(V_i,W_i)$. The errors are then the only random part of [(25.88a)](#equation-25-88-criterion). Apply the same rate argument conditionally, now with squared distance

<span id="equation-25-88-conditional-distance"></span>
...
and [(25.88i)](#equation-25-88-sobolev), together with the smallest eigenvalue of $A_n$, controls $|\theta|+\|\eta\|_\infty$ by $\mathbb P_n(g-g_0)^2+J^2(\eta)$. The conditional maximal inequality therefore has the same order as [(25.88f)](#equation-25-88-modulus). Theorem 25.81 conditionally gives

<span id="equation-25-88-boundedness"></span>
...
Thus $J(\widehat\eta)=O_P(1)$ and $\mathbb P_n\widehat g^2=O_P(1)$. Equations [(25.88j)](#equation-25-88-linear-part)–[(25.88l)](#equation-25-88-boundedness) imply

$$
|\widehat\theta|+\|\widehat\eta\|_\infty=O_P(1).
$$

The temporary restriction is now justified, so [(25.88h)](#equation-25-88-local-rate) proves consistency of $\widehat\theta$ and the stated $L_2(P_W)$ rate, while [(25.88l)](#equation-25-88-boundedness) supplies the two boundedness conclusions.
...
<span id="equation-25-11-partially-linear-efficient-score"></span>
...
<span id="equation-25-11-penalized-score"></span>
...
<span id="equation-25-89-score-consistency"></span>
...
<span id="equation-25-11-plr-dml-score"></span>
...
<span id="equation-25-11-plr-product-bias"></span>
...
- **Model double robustness:** the population moment in [(25.11t)](#equation-25-11-plr-product-bias) is exactly unbiased if either $\bar\eta=\eta_0$ or $\bar h=h_0$, even when the other working nuisance is misspecified.
...
<span id="equation-25-12-target-equation"></span>
...
<span id="equation-25-12-nuisance-score"></span>
...
<span id="equation-25-12-nuisance-equations"></span>
...
<span id="equation-25-12-psi-n"></span>
...
<span id="equation-25-12-psi"></span>
...
2. Along the estimator sequence, the scores are uniformly $L_2(P_0)$ consistent:
    ...
    <span id="equation-25-90-target-l2"></span>
    ...
    <span id="equation-25-90-nuisance-l2"></span>
...
<span id="equation-25-90-inverse"></span>
...
<span id="equation-25-90-equicontinuity"></span>
...
<span id="equation-25-90-root"></span>
...
<span id="equation-25-90-frechet"></span>
...
Substitution into [(25.90e)](#equation-25-90-root) yields

<span id="equation-25-90-preliminary"></span>
...
<span id="equation-25-90-inverse-bound"></span>
...
[(25.90h)](#equation-25-90-inverse-bound) to [(25.90g)](#equation-25-90-preliminary) and absorb the last term into the left side. This proves

$$
\sqrt n\|\widehat\xi-\xi_0\|=O_P(1).
$$

Returning to [(25.90f)](#equation-25-90-frechet), its scaled remainder is now $o_P(1)$. Equation [(25.90e)](#equation-25-90-root) therefore reduces to
...
$Z_n(\xi_0)=\sqrt n\,\Psi_n(\xi_0)$. This is (25.90). Applying the continuous inverse on the range gives [(25.90c)](#equation-25-90-inverse).
...
<span id="equation-25-12-joint-score-operator"></span>
...
<span id="equation-25-12-schur"></span>
...
<span id="equation-25-12-block-inverse"></span>
...
<span id="equation-25-92-kernel"></span>
...
<span id="equation-25-92-joint-information"></span>
...
Because $\widetilde I_0$ is nonsingular, [(25.92b)](#equation-25-92-joint-information) is strictly positive whenever $a_0\neq0$.

Now pair [(25.92a)](#equation-25-92-kernel) with $h$ under $\eta_0$. The adjoint identity and the definition of $K$ in [(25.12j)](#equation-25-12-k) give

<span id="equation-25-92-pairing"></span>
...
The last line is the information in [(25.92b)](#equation-25-92-joint-information). If $a_0\neq0$, it is strictly positive, contradicting [(25.92c)](#equation-25-92-pairing). Hence $a_0=0$, and therefore $r=0$ and $Kh=0$. Reinserting this in [(25.92a)](#equation-25-92-kernel) yields $B_0^*B_0h=0$. Since $B_0^*B_0$ is invertible, $h=0$. Thus $B_0^*B_0+K$ is one-to-one, and Lemma 25.93 completes the proof.
...
<span id="equation-25-93-coercive"></span>
...
Now suppose $Sx_j\to y$. Inequality [(25.93a)](#equation-25-93-coercive) makes the cosets $x_j+N(S)$ Cauchy in the Banach quotient $\mathbb B/N(S)$. Hence there are $x\in\mathbb B$ and $z_j\in N(S)$ such that $x_j-z_j\to x$. Because $S(x_j-z_j)=Sx_j$, continuity gives $Sx=y$. Thus $R(S)$ is closed.
...
<span id="equation-25-12-efficient-expansion"></span>
...
<span id="equation-25-12-cox-likelihood"></span>
...
<span id="equation-25-12-cox-target-score"></span>
...
<span id="equation-25-12-cox-nuisance-score"></span>
...
<span id="equation-25-12-cox-information-operator"></span>
...
<span id="equation-25-12-cox-m"></span>
...
<span id="equation-25-12-cox-efficient-score"></span>
...
<span id="equation-25-12-cox-efficient-information"></span>
...
Thus Theorem 25.90 yields the joint Gaussian limit, while [(25.12k)](#equation-25-12-efficient-expansion) shows directly that $\widehat\theta$ attains the semiparametric information bound.
...
<span id="equation-25-12-partially-missing-model"></span>
...
<span id="equation-25-12-partially-missing-likelihood"></span>
...
<span id="equation-25-12-partially-missing-target-score"></span>
...
<span id="equation-25-12-partially-missing-nuisance-score"></span>
...
<span id="equation-25-12-c-adjoint"></span>
...
<span id="equation-25-12-direct-information"></span>
...
<span id="equation-25-96-holder"></span>
...
<span id="equation-25-96-bound"></span>
...
Equation [(25.12x)](#equation-25-12-direct-information) gives
...
<span id="equation-25-12-mixture-derivative"></span>
